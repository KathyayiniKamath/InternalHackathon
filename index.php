...
<style>
   body{
    background-image:url("adimg.jpg") ;
   }
</style>
        ...
        <div class="auth-wrapper d-flex no-block justify-content-center align-items-center position-relative">
            ...
            <div  style="width:300px;height:400px;background-color:rgba(0, 0, 0, 0.324)">
                    <div class="p-3">
                        ...
                        <h2 class="mt-3 text-center"style="font-weight:bold;color:white">Student Login</h2>
                        ...
                        <form class="mt-4" method="POST">
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label class="text-dark" for="pwd"style="color:white">Password</label>

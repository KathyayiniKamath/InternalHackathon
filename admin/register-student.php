...
<head>
    ...
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="hostel.jpg">
...
<body style="background-image:url(..assets/images/back1.jpg);background-repeat: no-repeat; background-size: cover; background-position: center center;">  
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <div class="page-wrapper">
            ...
            <!-- Container fluid  -->
            <!-- ============================================================== -->
            <div class="container-fluid" style="background-image: url('../assets/images/hostel2.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center" >
                ...
                <form method="POST" name="registration" onSubmit="return valid();">
                    ...
                    <div class="row"> 
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card"  style="background-color:rgb(158, 207, 214)">
                                <div class="card-body">
                        ...
                        <div class="col-sm-12 col-md-6 col-lg-4">
                            <div class="card" >
                                <div class="card-body" style="background-color:rgb(158, 207, 214)" >

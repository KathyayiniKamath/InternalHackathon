...
<body >
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        data-sidebar-position="fixed" data-header-position="fixed" data-boxed-layout="full" style="background-color:red">
        ...
        <aside class="left-sidebar" data-sidebarbg="skin6" style="background-color:rgb(13, 13, 184)">
            <!-- Sidebar scroll-->
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb"style="background-color:rgb(13, 13, 184)">
                <div class="row">
            ...
            <div class="container-fluid"style="background-image: url('../assets/images/background.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">

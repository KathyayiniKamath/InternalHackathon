...
<body style="background-image:url('..assets/images/roomback.jpeg');background-repeat: no-repeat; background-size: cover; background-position: center center; margin: 0;background-size: cover;background-position: center center;">
...
<head>
    ...
    <div class="maindiv"style="background-image: url('../assets/images/background.jpg'); background-repeat: no-repeat; background-size: cover; background-position: center center;">
    <div class="preloader">
    ...
    <div id="main-wrapper" data-theme="light" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <!-- ============================================================== -->
        <header class="topbar" data-navbarbg="skin6" style="background-color: rgb(7, 7, 201);">
        ...
        <aside class="left-sidebar" data-sidebarbg="skin6" >
            <!-- Sidebar scroll-->
            <div class="scroll-sidebar" data-sidebarbg="skin6" style="background-color: rgb(23, 100, 172);">
            ...
            <!-- End Sidebar scroll-->
                ...
                <div class="row" style="margin-left:100px;">
                    ...
                    <h4  style="font-weight:bold;color:white;">Add Rooms</h4>

...
<nav class="sidebar-nav">
    ...
    <ul id="sidebarnav">
        ...
        aria-expanded="false" style="background-color:chartreuse"><i data-feather="home" class="feather-icon"></i><span
        ...
        aria-expanded="false"  style="background-color:aquamarine"><i class="fas fa-user-plus"></i><span
